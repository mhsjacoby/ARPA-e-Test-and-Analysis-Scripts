...
class MyConfiguration():
    def __init__(self, path_to_import_conf):
...
class AudioChecker():
    ...
    def main(self):
                    ...
                    if a < self.b_dt_as_dt or a > self.e_dt_as_dt:
                        ...
                        if os.path.isdir(temp):
                            ...
                            if self.total_wavs > self.counter_min:
                                ...
                                mins = rt.seconds / 60
                                print('Current runtime in mins: {0:.1f}'.format(mins))
        ...
        print('Percent of audio files captured: ' + str(self.perc_cap))
...
class PhotoChecker():
    ...
    def main(self):
        ...
        print('Percent of image files captured: ' + str(self.perc_cap))
        return(self.perc_cap)
