...
class ImageChecker():
    def __init__(self, server_id, days_to_check, test, display_output = True, write_file = True):
        ...
        self.store_dir = os.path.join(self.store, self.server_id + '_img_output_dicts')  
    ...
    def count_images(self, hr_mins):
        total_images = 0
        for folder in hr_mins:
            img_per_min = len(mylistdir(folder))
    ...
    def configure_output(self,d):
        if self.write_file or self.display_output:
            ...
            output_dict_write = {
                ...
                'Expected number of directories': len(self.correct_dirs_per_day),
    ...
    def main(self):
        ...
        for d in self.date_folders:
            ...
            self.total_imgs = self.count_images(self.hr_min_dirs)   
