...
class siamese(object):
    def __init__(self,img_size,img_channels,load_weights):
        ...
        self.model.add(Conv2D(32, kernel_size=(3, 3), strides=(1, 1),activation='relu',input_shape=input_shape))
        self.model.add(MaxPooling2D(pool_size=(2, 2), strides=(2, 2)))
        ...
        prediction = Dense(50,activation='sigmoid',bias_initializer=b_init)(both)
        prediction = Dense(20,activation='sigmoid',bias_initializer=b_init)(prediction)
        prediction = Dense(1,activation='sigmoid',bias_initializer=b_init)(prediction)
        ...
        if(load_weights==True):
            ...
            self.siamese_net.load_weights('weights/model_weight[1, 1]')
